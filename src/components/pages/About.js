  ...
  return (
    <>
            ...
            <div className='c-content-bar-2 c-opt-1'>
                <div className='row'>
                    <div className='col-md-12'>
                        ...
                        <h2 className='c-font-bold'>Comfort</h2>
                        <p className='c-font-gray-3'>
                        ...
                        <h2 className='c-font-bold'>Design</h2>
                        <p className='c-font-gray-3'>
                        ...
                        <h2 className='c-font-bold'>Quality</h2>
                        <p className='c-font-gray-3'>
      ...
      <div className='c-content-box c-bg-white'>
        <div className='container'>
            <div className='c-content-box c-margin-t-0'>
                <h2 className='c-line-height-30'>Hartman globally is headquartered in Enschede (the Netherlands) with sales offices here in the UK as well as Belgium, Germany and the Czech Republic.</h2>
            </div>
        </div>
      </div>
